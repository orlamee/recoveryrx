...
const PrivacyPolicyModal = ({ isOpen, onClose }: PrivacyPolicyModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex justify-center items-start p-4 overflow-y-auto">
      <div className="relative bg-black w-full max-w-4xl mx-auto my-8 p-8 rounded-2xl shadow-2xl border border-gray-700">
        <button
          onClick={onClose}
        ...
        <div className="prose dark:prose-invert max-w-none">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold text-[#6e573b] mb-4">
              Privacy Policy
            </h1>
          ...
          <div className="space-y-8">
            <section className="space-y-4">
              <p className="text-sm leading-relaxed text-white">
                At RecoveryRx, we are committed to protecting your privacy and
                ensuring the confidentiality of your personal and health-related
                information. This Privacy Policy explains how we collect, use,
                disclose, and safeguard your information when you visit our
                website www.recoveryrxclinic.com or interact with our
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-[#6e573b] border-b border-gray-200 dark:border-gray-700 pb-2">
              ...
              <h3 className="text-lg font-semibold text-[#6e573b] mt-4">
                Personal Information
              </h3>
              <ul className="space-y-2 pl-5 list-disc marker:text-[#6e573b] text-sm text-white">
                <li className="pl-2">
                  Full name, email address, phone number, mailing address
                </li>
                <li className="pl-2">Date of birth or age</li>
                <li className="pl-2">
                  Medical history, treatment preferences, or other
                  health-related data (if submitted via forms)
                </li>
              </ul>
              ...
              <p className="text-white text-sm">
                ...
                experience and understand how you interact with our website. You
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-2 pl-5 list-disc marker:text-[#6e573b] text-sm text-white">
                <li className="pl-2">
                  Provide and manage medical or wellness services
                </li>
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-2 pl-5 list-disc marker:text-[#6e573b] text-sm text-white">
                <li className="pl-2">
                  With healthcare providers and staff involved in your care
                </li>
                <li className="pl-2">
                  With trusted third-party service providers who support our
                  operations (e.g., website hosting, analytics)
                </li>
                <li className="pl-2">
                  As required by law or to comply with legal obligations (e.g.,
                  court orders, subpoenas)
                </li>
                <li className="pl-2">
                  In emergency situations where your health or safety is at risk
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-white text-sm">
                ...
                protect your personal and health information from unauthorized
                access, disclosure, or misuse. This includes encryption, access
                controls, and secure server environments.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-white text-sm">
                As a healthcare-focused organization, RecoveryRx complies with
                the Health Insurance Portability and Accountability Act (HIPAA)
                where applicable. We ensure the privacy and protection of any
                Protected Health Information (PHI) submitted through our
                platform or in-person services.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-white text-sm">
                ...
                we will revise the "Effective Date" above and post the updated
