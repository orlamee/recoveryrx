        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <div className="space-y-8">
            ...
            <section className="space-y-4">
              ...
              <h3 className="text-lg font-semibold text-[#6e573b] mt-4">Personal Information</h3>
              ...
              <h3 className="text-lg font-semibold text-[#6e573b] mt-4">Automatically Collected Information</h3>
              <ul className="space-y-2 pl-5 list-disc marker:text-[#6e573b] text-sm text-white">
              ...
              <h3 className="text-lg font-semibold text-[#6e573b] mt-4">Cookies & Tracking Technologies</h3>
              <p className="text-white text-sm">
